      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 py-16 sm:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-start gap-12 sm:gap-20">
          ...
          <div className="lg:col-span-7 text-center sm:text-left space-y-8 sm:space-y-10 order-2 lg:order-1">
            ...
            >
              I'm <span className="text-emerald-600 dark:text-emerald-400">{DEV_INFO.name}</span>, a self-learned developer from Burundi. I'm still a student, currently in fourth year school of Business and economics taking Bachelor of Business Management at Moi University - Eldoret.
